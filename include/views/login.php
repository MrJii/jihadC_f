...
<div id="logo">
<a href="<?php echo jihadCconf::get('base_url')?>"><img alt="jihadCloud" src="<?php echo jihadCconf::get('base_url')?>/include/views/img/logo.gif"></a>
</div>
...
<?php if (jihadCconf::get('enable_password_recovery')):?>
...
<?php if (jihadCconf::get('allow_signup')):?>
<input class="nice radius secondary button" style="float:left;" type="Submit" value="<?php echo lang::get("Sign up")?>" onclick="window.location='<?php echo jihadCconf::get('base_url')?>/?signup=1&'; return false;"> 
<?php endif;?>
    ...
    $('#password-recovery').click(function(){
		...
		output += '</div>';
 		...
 		$('#confirm-button').click(function(){
			...
			$.post("<?php echo jihadCconf::get('base_url')?>/?recover_password=1", { emaildata: usersemail} ).done(function(data) {
				// show ok
