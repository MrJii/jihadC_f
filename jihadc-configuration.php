...
/**
 *
 * Configuration JC Store options
 *
...
class jihadCconf {
	...
	public static function get($param) {
		...
		$config = array(
				...
				'use_database' => false,
				'db_host' => 'jihadcloudServer',
				'db_username' => 'jihadcloudUser',
				'db_password' => 'jihadcloudPassword',
				'db_database' => 'jihadcloudSQL',
				...
				// email configuration
				'mail_from' => 'saaduddinj@gmail.com',
				'mail_from_name' => 'info',
				'mail_signature' => "\n\nBest Regards,\nJihad CLOUD, Inc.",
				...
				'mail_smtp_username' => 'saaduddinj@gmail.com',
				...
				// if your repository is outside jcloud's main folder you need to set this
				// this will serve as a base url/directory for all direct links
				// example: 
				// 'direct_links_baseurl' => 'http://example.com/jcloud-',
				// 'direct_links_repository' => '/var/www/html/jihadCloud',
		...
		*/
		...
		if (class_exists('jihadC')) $config = jihadC::validateConf($config, $param);
